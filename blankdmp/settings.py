"""
Django settings for blankdmp project.
...
SECRET_KEY = '*uh6%cwsvdrng-7l+dj-0ifk-0q1l1jinf%wlr))(#9rsu!&oa'
...
WSGI_APPLICATION = 'blankdmp.wsgi.application'
